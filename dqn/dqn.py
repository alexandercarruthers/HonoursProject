...
writer = tf.summary.FileWriter("/tensorboard/doom/dqn/" + datetime.datetime.now().strftime("%d-%m-%Y") + "/" + datetime.datetime.now().strftime("%H-%M"))
## Losses
...
writer = tf.summary.FileWriter("/tensorboard/doom/dqn/" + datetime.datetime.now().strftime("%H-%M %d-%m-%Y"),sess.graph)
            ...
            while step < max_steps:
                ...
                if done:
                    ...
                    print('Episode: {}'.format(episode),
                          'Score: {}'.format(game.get_total_reward()),
