...
class Worker():
    def __init__(self, game, name, s_size, a_size, trainer, model_path, global_episodes):
        ...
        #self.summary_writer = tf.summary.FileWriter("/tensorboard/" + "basic" + "/" + "a3c" + "/1/" + str(self.number))
        self.summary_writer = tf.summary.FileWriter(writer_path + "/" + str(self.number))
        ...
        #game.load_config("./scenarios/" + "basic" + ".cfg")  # Load the correct configuration
        #
...
with tf.device("/cpu:0"):
    ...
    for i in range(num_workers):
        workers.append(Worker(vizdoom.DoomGame(), i, s_size, a_size, trainer, model_path, global_episodes))
